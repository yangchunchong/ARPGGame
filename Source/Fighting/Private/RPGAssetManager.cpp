...
URPGAssetManager& URPGAssetManager::Get()
{
	...
	{
		UE_LOG(LogFighting, Fatal, TEXT("Invalid AssetManager in DefaultEngine.ini, must be RPGAssetManager!"));
...
{	
	...
	{
		UE_LOG(LogFighting, Warning, TEXT("Failed to load item for identifier %s!"), *PrimaryAssetId.ToString());
	}
