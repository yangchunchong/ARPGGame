...
class FIGHTING_API URPGTargetType : public UObject
{
	GENERATED_BODY()
...
class FIGHTING_API URPGTargetType_UseOwner : public URPGTargetType
{
	GENERATED_BODY()
...
UCLASS(NotBlueprintable)
class FIGHTING_API URPGTargetType_UseEventData : public URPGTargetType
{
	GENERATED_BODY()
