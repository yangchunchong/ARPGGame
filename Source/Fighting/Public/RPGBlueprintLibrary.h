...
public:
	...
	//Calculate the srcInt Has PlotIndex Num
	UFUNCTION(BlueprintCallable, Category = "Common")
	static bool HasPlotIndex(int64 SrcInt, int64 CheckInt, int64& ResultInt);

	//Return PlotIndex Num
	UFUNCTION(BlueprintPure, Category = "Common")
	static int64 GetCheckPlotNum(int64 CheckInt);
